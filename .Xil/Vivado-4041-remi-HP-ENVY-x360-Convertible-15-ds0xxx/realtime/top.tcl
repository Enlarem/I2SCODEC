...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-4041-remi-HP-ENVY-x360-Convertible-15-ds0xxx/realtime/tmp"
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-4041-remi-HP-ENVY-x360-Convertible-15-ds0xxx/"
